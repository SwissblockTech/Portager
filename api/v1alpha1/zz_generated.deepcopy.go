...
func (in *ValidationConfig) DeepCopyInto(out *ValidationConfig) {
	*out = *in
	...
	if in.VulnerabilityGate != nil {
		in, out := &in.VulnerabilityGate, &out.VulnerabilityGate
		*out = new(VulnerabilityGateConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VulnerabilityGateConfig) DeepCopyInto(out *VulnerabilityGateConfig) {
	*out = *in
	if in.RequireCveReport != nil {
		in, out := &in.RequireCveReport, &out.RequireCveReport
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VulnerabilityGateConfig.
func (in *VulnerabilityGateConfig) DeepCopy() *VulnerabilityGateConfig {
	if in == nil {
		return nil
	}
	out := new(VulnerabilityGateConfig)
